...
if OPERATING_SYSTEM == "Darwin":
    ...
    raise RuntimeError(f"could not recognize current os: {OPERATING_SYSTEM}")
...
class ToolTip(object):
    ...
    def showtip(self, text, is_message_box=False, is_success_message=None):  #
        ...
        if is_message_box:
            self.tooltip.after(
                3000 if type(is_success_message) is bool else 2000, self.hidetip
            )
...
class ListboxBatchFrame(tk.Frame):
    def __init__(
        self, master=None, name="Listbox", command=None, image_sel=None, img_mapper=None
    ):
    ...
    def select_input(self, inputs=None):
        ...
        for file in files:
            if (
                file not in self.path_list
            ):  # only add file if it's not already in the list
    ...
    def duplicate_selected(self):
        ...
        if selected:
            ...
            path_to_duplicate = self.basename_to_path[
                basename
...
class ComboBoxMenu(ttk.Combobox):
    ...
    def update_dropdown_size(
        self, option_list, dropdown_name, offset=185, command=None
    ):
        ...
        style.configure(
            dropdown_style, padding=(0, 0, 0, 0), postoffset=(0, 0, width_in_pixels, 0)
        )
...
class MainWindow(TkinterDnD.Tk if is_dnd_compatible else tk.Tk):
    ...
    def __init__(self):
        ...
        height += (
            self.CONVERSIONBUTTON_HEIGHT + self.COMMAND_HEIGHT + self.PROGRESS_HEIGHT
        )
    ...
    def ensemble_listbox_get_all_selected_models(self):
        return [
            ...
            for i in self.ensemble_listbox_Option.curselection()
        ]
    ...
    def fill_options_Frame(self):
        ...
        self.help_hints(
            self.chosen_process_method_Label, text=CHOSEN_PROCESS_METHOD_HELP
        )
        ...
        self.save_current_settings_Label_place = (
            lambda: self.save_current_settings_Label.place(
                x=MAIN_ROW_2_X[0],
                y=LOW_MENU_Y[0],
                width=0,
                height=LABEL_HEIGHT,
        ...
        self.save_current_settings_Option_place = (
            lambda: self.save_current_settings_Option.place(
                x=MAIN_ROW_2_X[1],
                y=LOW_MENU_Y[1],
        ...
        self.help_hints(
            self.save_current_settings_Label, text=SAVE_CURRENT_SETTINGS_HELP
        )
        ...
        self.aggression_setting_Label_place = (
            lambda: self.aggression_setting_Label.place(
                x=MAIN_ROW_2_X[0],
                y=MAIN_ROW_2_Y[0],
                width=0,
                height=LABEL_HEIGHT,
        ...
        self.aggression_setting_Option_place = (
            lambda: self.aggression_setting_Option.place(
                x=MAIN_ROW_2_X[1],
                y=MAIN_ROW_2_Y[1],
                width=MAIN_ROW_WIDTH,
                height=OPTION_HEIGHT,
        ...
        self.is_primary_stem_only_Demucs_Option_place = (
            lambda: self.is_primary_stem_only_Demucs_Option.place(
                x=CHECK_BOX_X,
                y=CHECK_BOX_Y,
        ...
        self.help_hints(
            self.is_primary_stem_only_Demucs_Option, text=SAVE_STEM_ONLY_HELP
        )
        ...
        self.help_hints(
            self.is_secondary_stem_only_Demucs_Option, text=SAVE_STEM_ONLY_HELP
        )
        ...
        self.ensemble_main_stem_Label_place = (
            lambda: self.ensemble_main_stem_Label.place(
                x=MAIN_ROW_X[0],
                y=MAIN_ROW_Y[0],
                width=0,
                height=LABEL_HEIGHT,
        ...
        self.ensemble_main_stem_Option_place = (
            lambda: self.ensemble_main_stem_Option.place(
                x=MAIN_ROW_X[1],
                y=MAIN_ROW_Y[1],
                width=MAIN_ROW_WIDTH,
                height=OPTION_HEIGHT,
        ...
        self.chosen_audio_tool_Option_place = (
            lambda: self.chosen_audio_tool_Option.place(
                x=0,
                y=LOW_MENU_Y[1],
                width=LEFT_ROW_WIDTH,
                height=OPTION_HEIGHT,
        ...
        self.time_stretch_rate_Option_place = (
            lambda: self.time_stretch_rate_Option.place(
                x=MAIN_ROW_X[1],
                y=MAIN_ROW_Y[1],
                width=MAIN_ROW_WIDTH,
                height=OPTION_HEIGHT,
        ...
        self.is_time_correction_Option_place = (
            lambda: self.is_time_correction_Option.place(
                x=CHECK_BOX_X,
                y=CHECK_BOX_Y,
                width=CHECK_BOX_WIDTH,
                height=CHECK_BOX_HEIGHT,
        ...
        self.is_gpu_conversion_Option_place = (
            lambda: self.is_gpu_conversion_Option.place(
                x=CHECK_BOX_X,
                y=CHECK_BOX_Y,
                width=CHECK_BOX_WIDTH,
                height=CHECK_BOX_HEIGHT,
        ...
        self.is_primary_stem_only_Option_place = (
            lambda: self.is_primary_stem_only_Option.place(
                x=CHECK_BOX_X,
                y=CHECK_BOX_Y,
                width=CHECK_BOX_WIDTH,
                height=CHECK_BOX_HEIGHT,
        ...
        self.is_secondary_stem_only_Option_place = (
            lambda: self.is_secondary_stem_only_Option.place(
                x=CHECK_BOX_X,
                y=CHECK_BOX_Y,
                width=CHECK_BOX_WIDTH,
                height=CHECK_BOX_HEIGHT,
        ...
        self.model_sample_mode_Option_place = (
            lambda rely=8: self.model_sample_mode_Option.place(
                x=CHECK_BOX_X,
                y=CHECK_BOX_Y,
                width=CHECK_BOX_WIDTH,
                height=CHECK_BOX_HEIGHT,
        ...
        try:
            ...
            for dir in DIRECTORIES:
                for temp_file in os.listdir(dir):
                    if (
                        temp_file.endswith(EXTENSIONS)
                        and "requirement" not in temp_file
                    ):
    ...
    def error_dialoge(self, message):
        ...
        messagebox.showerror(
            master=self, title=message[0], message=message[1], parent=root
        )
    ...
    def model_list(
        ...
        def matches_stem(model: ModelData):
            ...
            mdx_stem_match = (
                primary_stem in model.mdx_model_stems and model.mdx_stem_count <= 2
            )
            return (
        ...
        for model in stem_check:
            ...
            elif is_4_stem_check and (
                model.demucs_stem_count == 4 or model.mdx_stem_count == 4
            ):
                result.append(model.model_and_process_tag)
        ...
        def copy_help_hint(event):
            if self.help_hints_var.get():
                right_click_menu = tk.Menu(
                    self, font=(MAIN_FONT_NAME, FONT_SIZE_1), tearoff=0
                )
    ...
    def input_dual_right_click_menu(self, event, is_primary: bool):
        input_path = (
            ...
            if is_primary
            else self.fileTwoEntry_Full_var.get()
        )
        right_click_menu = tk.Menu(self, font=(MAIN_FONT_NAME, FONT_SIZE_1), tearoff=0)
        right_click_menu.add_command(
    ...
    def right_click_menu_paste(self, text_box=False):
        ...
        self.right_click_menu_delete(
            text_box=True
        ) if text_box else self.right_click_menu_delete()
    ...
    def adjust_toplevel_positions(self, event):
        ...
        for toplevel in self.toplevels.copy():
            ...
            if not toplevel.winfo_exists():
                ...
                toplevel.geometry(
                    "+%d+%d"
                    % (root.winfo_x() + menu_offset_x, root.winfo_y() + menu_offset_y)
                )
    ...
    def menu_placement(
        ...
        window.geometry(
            "+%d+%d"
            % (root_location_x + menu_offset_x, root_location_y + menu_offset_y)
        )
        ...
        def right_click_menu(event):
            help_hints_label = (
                "Enable" if self.help_hints_var.get() == False else "Disable"
            )
        ...
        if pop_up:
            window.attributes(
                "-topmost", "true"
            ) if OPERATING_SYSTEM == "Linux" else None
            window.grab_set()
    ...
    def menu_tab_control(
        self, toplevel, ai_network_vars, is_demucs=False, is_mdxnet=False
    ):
        ...
        if is_demucs or is_mdxnet:
            ...
            tabControl.add(
                tab3,
                text=PREPROCESS_MODEL_CHOOSE_TEXT
                if is_demucs
                else MDX23C_ONLY_OPTIONS_TEXT,
            )
        ...
        def on_tab_selected(event):
            ...
            if (
                ...
                event.widget.tab("current", option="text")
    ...
    def menu_view_inputs(self):
        ...
        reset_list = lambda: (
            ...
            [
                input_files_listbox_Option.insert(tk.END, inputs)
                for inputs in self.inputPaths
            ],
        )
        audio_input_total = lambda: input_length_var.set(
        ...
        def box_size():
            ...
            input_files_listbox_Option.config(
                width=230, height=25
            ) if is_widen_box_var.get() else input_files_listbox_Option.config(
                width=110, height=17
            )
        ...
        def pop_open_file_path(is_play_file=False):
            if self.inputPaths:
                track_selected = self.inputPaths[
                    input_files_listbox_Option.index(tk.ACTIVE)
                ]
                if os.path.isfile(track_selected):
                    OPEN_FILE_func(
                        track_selected
                        if is_play_file
                        else os.path.dirname(track_selected)
                    )
        ...
        def verify_audio(is_create_samples=False):
            ...
            if iterated_list:
                ...
                if removed_files:
                    ...
                    self.error_log_var.set(
                        REMOVED_FILES(list_to_string(removed_files), error_text)
                    )
                    self.inputPaths = tuple(inputPaths)
                    self.update_inputPaths()
                else:
    ...
    def menu_batch_dual(self):
        ...
        def drag_n_drop(event, accept_mode):
            ...
            for item in paths:
                if (
                    item not in listbox.path_list
                ):  # only add file if it's not already in the list
                    basename = os.path.basename(item)
                    listbox.listbox.insert(
                        tk.END, basename
    ...
    def menu_advanced_vr_options(self):  # **
        ...
        self.help_hints(
            self.post_process_threshold_Label, text=POST_PROCESS_THREASHOLD_HELP
        )
    ...
    def menu_advanced_demucs_options(self):  # **
        ...
        demuc_opt.protocol(
            "WM_DELETE_WINDOW", self.menu_advanced_demucs_options_close_window
        )
        ...
        self.help_hints(
            self.is_demucs_combine_stems_Option, text=IS_DEMUCS_COMBINE_STEMS_HELP
        )
    ...
    def menu_advanced_mdx_options(self):  # **
        ...
        mdx_net_opt.protocol(
            "WM_DELETE_WINDOW", self.menu_advanced_mdx_options_close_window
        )
        ...
        if not os.path.isfile(DENOISER_MODEL_PATH):
            ...
            self.denoise_option_var.set(
                DENOISE_S
                if denoise_options_var_text == DENOISE_M
                else denoise_options_var_text
            )
        else:
    ...
    def menu_advanced_ensemble_options(self):  # **
        ...
        self.help_hints(
            is_save_all_outputs_ensemble_Option, text=IS_SAVE_ALL_OUTPUTS_ENSEMBLE_HELP
        )
    ...
    def menu_help(self):  # **
        ...
        section_title_Label = (
            lambda place, frame, text, font_size=FONT_SIZE_4: tk.Label(
                master=frame,
                text=text,
        ...
        def credit_label(
            place, frame, text, link=None, message=None, is_link=False, is_top=False
        ):
            if is_top:
                thank = tk.Label(
                    master=frame,
    ...
    def menu_secondary_model(self, tab, ai_network_vars: dict):
        ...
        voc_inst_secondary_model_scale_var = ai_network_vars[
        ...
        def change_state(change_state):
            for child_widget in secondary_model_Frame.winfo_children():
                if type(child_widget) is ComboBoxMenu:
                    change_state = (
                        READ_ONLY if change_state == tk.NORMAL else change_state
                    )
        ...
        def convert_to_percentage(
            raw_value, scale_var: tk.StringVar, label_var: tk.StringVar
        ):
        ...
        self.help_hints(
            is_secondary_model_activate_Option, text=SECONDARY_MODEL_ACTIVATE_HELP
        )
    ...
    def menu_preproc_model(self, tab):
        ...
        self.help_hints(
            is_demucs_pre_proc_model_inst_mix_Option, text=PRE_PROC_MODEL_INST_MIX_HELP
        )
        ...
        self.help_hints(
            is_demucs_pre_proc_model_activate_Option, text=PRE_PROC_MODEL_ACTIVATE_HELP
        )
    ...
    def menu_manual_downloads(self):
        ...
        def get_links():
            ...
            self.menu_sub_LABEL_SET(
                manual_downloads_link_Frame, "Download Link(s)"
            ).grid(row=0, column=0, padx=0, pady=MENU_PADDING_4)
            ...
            if type(main_selection) is dict:
                for links in main_selection.values():
                    MAIN_ROW += 1
                    button_text = (
                        f" - Item {MAIN_ROW}" if len(main_selection.keys()) >= 2 else ""
                    )
    ...
    def pop_up_save_current_settings(self):
        ...
        validation = (
            lambda value: False if re.fullmatch(REG_SAVE_INPUT, value) is None else True
        )
    ...
    def pop_up_update_confirmation(self):
        ...
        if is_new_update:
            ...
            self.menu_placement(
                update_confirmation_win, CONFIRM_UPDATE_TEXT, pop_up=True
            )
    ...
    def pop_up_set_vocal_splitter(self, top_window):
        ...
        try:
            ...
            deverb_opt_toggle = (
                ...
                if self.is_deverb_vocals_var.get()
            ...
            self.help_hints(
                save_inst_Button, text=IS_VOC_SPLIT_INST_SAVE_SELECT_HELP
            )  #
            ...
            self.help_hints(
                change_params_Button, text=IS_VOC_SPLIT_MODEL_SELECT_HELP
            )  #
    ...
    def pop_up_mdx_model(self, mdx_model_hash, model_path):
        ...
        try:
            ...
            if model_path.endswith(CKPT):
                ...
                for stem in STEM_SET_MENU:
                    if model_params["target_name"] == stem.lower():
                        primary_stem = (
                            INST_STEM
                            if model_params["target_name"] == OTHER_STEM.lower()
                            else stem
                        )
            ...
            if is_ckpt:
                ...
                self.error_log_var.set(
                    "{}".format(error_text("MDX-Net Model Settings", e))
                )
                self.mdx_model_params = None
        ...
        if is_compatible_model:
            ...
            set_stem_name_Option["menu"].add_radiobutton(
                ...
                command=tk._setit(
                    primary_stem_var,
                    INPUT_STEM_NAME,
                    lambda e: self.pop_up_input_stem_name(
                        primary_stem_var, mdx_model_set
                    ),
                ),
            )
    ...
    def pop_up_input_stem_name(
        self, stem_var: tk.StringVar, parent_window: tk.Toplevel
    ):
        """
        Input Stem Name
        """
        ...
        def close_window(is_cancel=True):
            if is_cancel or not stem_input_save_var.get():
                ...
                if stem_input_save_text == VOCAL_STEM:
                    stem_text = (
                        INST_STEM if is_inverse_stem_var.get() else stem_input_save_text
                    )
        ...
        validation = (
            lambda value: False
            if re.fullmatch(REG_INPUT_STEM_NAME, value) is None
            else True
        )
    ...
    def pop_up_save_ensemble_sub_json_dump(
        self, selected_ensemble_model, ensemble_save_name: str
    ):
            ...
            try:
                ...
                if self.lastest_version == current_patch and not is_start_up:
                    ...
                    if not user_refresh:
                        if (
                            not is_beta_version
                            and not self.lastest_version == current_patch
                        ):
                            self.command_Text.write(
            ...
            for selectable, model in self.demucs_download_list.items():
                for name in model.items():
                    if [True for x in DEMUCS_NEWER_ARCH_TYPES if x in selectable]:
                        if not os.path.isfile(
                            os.path.join(DEMUCS_NEWER_REPO_DIR, name[0])
                        ):
    ...
    def download_model_select(self, selection, type, var: tk.StringVar):
        ...
        model_repo = (
            self.decoded_vip_link if VIP_SELECTION in selection else NORMAL_REPO
        )
    ...
    def download_item(self, is_update_app=False):
        ...
        is_demucs_newer = [
            ...
            if x in self.selected_download_var.get()
        ]
        ...
        def push_download():
            ...
            try:
                if is_update_app:
                    ...
                    if (
                        self.select_download_var.get() == DEMUCS_ARCH_TYPE
                        and is_demucs_newer
                    ):
    ...
    def update_menus(
        ...
        if new_items != last_items:
            ...
            final_options = (
                formatted_items + base_options if base_options else formatted_items
            )
    ...
    def update_available_models(self):
        ...
        def loop_directories(
            ...
            if not option_list and self.is_online:
                option_list_option_menu = [
                    option
                    for option in option_list_option_menu
                    if option != OPT_SEPARATOR
                ]
            ...
            return tuple(
                f"{model_type}{ENSEMBLE_PARTITION}{model_name}"
                for model_name in sorted_options
            )
        ...
        if new_models_found != self.last_found_models or is_online != self.is_online:
            ...
            self.ensemble_model_list = (
                vr_model_list + mdx_model_list + demucs_model_list
            )
    ...
    def update_main_widget_states(self):
        ...
        def general_shared_buttons():
            place_widgets(
                self.is_gpu_conversion_Option_place, self.model_sample_mode_Option_place
            )
        ...
        if process_method == MDX_ARCH_TYPE:
            ...
            place_widgets(
                self.chosen_audio_tool_Label_place, self.chosen_audio_tool_Option_place
            )
    ...
    def selection_action(self, event, option_var, is_mdx_net=False):
        ...
        selected_value = (
            CHOOSE_MODEL if selected_value == OPT_SEPARATOR else selected_value
        )
    ...
    def selection_action_models_sub(self, selection, ai_type, var: tk.StringVar):
        ...
        if not is_model_status:
            ...
            if ai_type == DEMUCS_ARCH_TYPE:
                if (
                    not self.demucs_stems_var.get().lower()
                    in model_data.demucs_source_list
                ):
    ...
    def selection_action_chosen_ensemble_load_saved(self, saved_ensemble):
        ...
        if saved_data:
            ...
            for saved_model in self.saved_model_list:
                status = self.assemble_model_data(saved_model, ENSEMBLE_CHECK)[
                    0
                ].model_status
                if not status:
    ...
    def selection_action_ensemble_stems(
        self, selection: str, from_menu=True, auto_update=None
    ):
    ...
    def process_check_wav_type(self):
        if self.wav_type_set_var.get() == "32-bit Float":
            ...
            self.wav_type_set = (
                "FLOAT" if not self.save_format_var.get() == WAV else "DOUBLE"
            )
        else:
    ...
    def process_preliminary_checks(self):
        ...
        if self.chosen_process_method_var.get() == VR_ARCH_PM:
            continue_process = (
                lambda: False if self.vr_model_var.get() == CHOOSE_MODEL else True
            )
        if self.chosen_process_method_var.get() == MDX_ARCH_TYPE:
            continue_process = (
                lambda: False if self.mdx_net_model_var.get() == CHOOSE_MODEL else True
            )
        if self.chosen_process_method_var.get() == DEMUCS_ARCH_TYPE:
            continue_process = (
                lambda: False if self.demucs_model_var.get() == CHOOSE_MODEL else True
            )
    ...
    def process_tool_start(self):
        ...
        def handle_alignment_match(
            ...
            audio_file_2_base = (
                f"{os.path.splitext(os.path.basename(audio_file[1]))[0]}"
            )
        ...
        if self.chosen_audio_tool_var.get() in [ALIGN_INPUTS, MATCH_INPUTS]:
            if self.DualBatch_inputPaths:
                ...
                if (
                    not self.fileOneEntry_Full_var.get()
                    or not self.fileTwoEntry_Full_var.get()
                ):
        ...
        try:
            ...
            for file_num, audio_file in enumerate(inputPaths, start=1):
                ...
                command_Text = lambda text: self.command_Text.write(
                    self.base_text + text
                )
            ...
            if total_files == 1 and not is_verified_audio:
                ...
                self.command_Text.write(
                    "{}{}".format(process_complete_text, time_elapsed())
                )
    ...
    def process_determine_secondary_model(
        ...
        if main_model_primary_stem in [VOCAL_STEM, INST_STEM]:
            ...
            secondary_model_scale = secondary_model_vars[
                "voc_inst_secondary_model_scale"
            ].get()
    ...
    def process_start(self):
        ...
        try:
            ...
            true_model_4_stem_count = sum(
                m.demucs_4_stem_added_count
                if m.process_method == DEMUCS_ARCH_TYPE
                else 0
                for m in model
            )
            ...
            for file_num, audio_file in enumerate(inputPaths, start=1):
                ...
                for current_model_num, current_model in enumerate(model, start=1):
                    ...
                    model_name_text = (
                        f"({current_model.model_basename})" if not is_ensemble else ""
                    )
                    self.command_Text.write(
                    ...
                    set_progress_bar = (
                        lambda step,
                        inference_iterations=0: self.process_update_progress(
                            total_files=inputPath_total_len,
                            step=(step + (inference_iterations)),
                        )
                    )
                    write_to_console = (
                        lambda progress_text,
                        base_text=base_text: self.command_Text.write(
...
def extract_stems(audio_file_base, export_path):
    filenames = [
        file for file in os.listdir(export_path) if file.startswith(audio_file_base)
    ]
